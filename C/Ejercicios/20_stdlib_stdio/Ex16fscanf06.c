 ...
 * [Prefijo] Coloca antes de un especificador para indicar
	la \"anchura de campo\" de caracteres, a la hora de asignar el valor introducido. Sólo se asignarán los primeros x caracteres especificados por el número prefijo.
